...
export function AboutMe() {
  return (
    <section id="about-me" className="pt-6 pb-16 overflow-hidden" style={{scrollMarginTop:"72px"}}>
      <Container>
        {/* section label */}
        <motion.div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_38%] gap-12 items-start">
          {/* LEFT — text */}
          <motion.div
          ...
          >
            ...
            <div className="space-y-3 max-w-[600px]">
              <p
                className="font-heading leading-[1.7] m-0"
                style={{ fontSize: "clamp(15px,1.4vw,18px)", color: "#999" }}
              >
              ...
              <p
                className="font-heading leading-[1.7] m-0"
                style={{ fontSize: "clamp(15px,1.4vw,18px)", color: "#666" }}
              >
            ...
            {/* stat row */}
            <div className="flex gap-12 mt-8 pt-8 border-t border-[#1c1c1c]">
              {[
                ...
                <div key={label}>
                  ...
                  <div className="font-mono text-[10px] tracking-[0.2em] text-[#444] uppercase mt-1">{label}</div>
                </div>
              ))}
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative">
              <div className="absolute -top-3 -left-3 w-5 h-5 border-t border-l border-[#333]" />
              <div className="absolute -top-3 -right-3 w-5 h-5 border-t border-r border-[#333]" />
              <div className="absolute -bottom-3 -left-3 w-5 h-5 border-b border-l border-[#333]" />
              <div className="absolute -bottom-3 -right-3 w-5 h-5 border-b border-r border-[#333]" />

              <div className="w-full aspect-[4/5] overflow-hidden brightness-[0.95] transition-all duration-700 hover:brightness-100">
                <img
                  src={IMAGES.hero}
                  alt="Udbhaw"
              ...
              <motion.div
                ...
                className="absolute bottom-4 right-4 bg-background border border-[#2a2a2a] px-4 py-3 z-10"
            ...
            <a
              href="#contacts"
              className="flex items-center justify-between font-mono text-[11px] tracking-[0.16em] uppercase text-foreground border border-[#2a2a2a] px-6 py-4 no-underline transition-all hover:border-[#555] hover:bg-white/5"
            >
              Get in touch

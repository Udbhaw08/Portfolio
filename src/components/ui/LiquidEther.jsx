...
// Option 1 — Cold Blue / Violet dark theme
// Colors: deep blue #1a1aff, electric violet #6d28d9, near-black #0f172a
...
`;
  ...
  return (
    <div
      ref={mountRef}
      aria-hidden="true"
      className={`w-full h-full absolute inset-0 pointer-events-none touch-none ${className || ''}`}
